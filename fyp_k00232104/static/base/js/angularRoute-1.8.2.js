 ...
 *
 * ```js
     buyFormController.config(['$resourceProvider', function($resourceProvider) {
 ...
 *
   ...
   ```
 *
 * The object returned from a call to `$resource` is a resource "class" which has one "plots"
 ...
 *
   ```js
      var buyFormController = angular.module('buyFormController', ['ngResource']);

      // Some APIs expect a PUT request in the format URL/object/ID
      // Here we are creating an 'update' method
      buyFormController.factory('Notes', ['$resource', function($resource) {
      ...
      buyFormController.controller('NotesCtrl', ['$location', 'Notes', function($location, Notes) {
