'use strict';
let buyFormController = angular.module("buyOrderForm", []).controller("buyOrderFormController", function ($scope) {
...
buyFormController.config(function($locationProvider, $interpolateProvider){
